<?php
	...
	if ($logged = true) {
		...
		$photosData = $photosFolders->pullInfo(basename(__DIR__));
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Beavers - <?=basename(__DIR__)?></title>
			...
			<div class="beavers-main-content main-content">
				<div class="beavers-page-nav">
					<ul>
						<a href="../../" class="home">
							<li>
								<span class="page-nav-content"><span>Home</span></span>
							</li>
						</a>
						<a href="" class="documents">
							<li>
								<span class="page-nav-content"><span>Documents</span></span>
							</li>
						</a>
						<a href="../" class="photos active">
							<li>
								<span class="page-nav-content"><span>Photos</span></span>
							</li>
						</a>
						...
						<a href="" class="chat">
							<li>
								<span class="page-nav-content"><span>Contact Leaders</span></span>
							</li>
						</a>
						<span class="stretch"></span>
					</ul>
				</div>
				<h2 class="anim_element anim_element--fadeInLeft"><?= basename(__DIR__) ?></h2>
				...
				<div class="beavers-page-main anim_element anim_element--fadeInLeft">
					...
					<div class="grid photos">
						...
						<?
							$dirname = "";
							$images = glob($dirname."*.{jpg,gif,png,JPG,GIF,PNG,mp4,MP4}", GLOB_NOSORT + GLOB_BRACE);
							if (count($images) < 1) {
								echo "No images";
							}else{
								foreach($images as $image) { 
									...
									<div  class="photos-tile-photo grid-item">
										<a href="<?=$image?>" class="photo-container" data-lightbox="<?= basename(__DIR__) ?>" data-title="<?=$name['0']?>">
				...
				<div class="beavers-page-sidebar main-side">
					...
					<h2 class="anim_element anim_element--fadeIn"><?= basename(__DIR__) ?></h2>
					<div class="anim_element anim_element--fadeIn">
						<p><?= count($images) ?> images, created on <?= $photosData['date'] ?>.</p>
...
<?
	...
	if (!empty($_POST['directory'])) {
		include($_PUBLIC_DIR . '_includes/upload/server/phpUploadHandler.php');
