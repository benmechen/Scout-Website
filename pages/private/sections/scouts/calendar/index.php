...
session_start();
	...
	if ($logged = true) {
		...
		// Set up Calendar
		$calendarId = '0hnt27o7vdr6i9eoe6r186krv8@group.calendar.google.com';
		$params = array(
		...
		$calendar = new Calendar('0hnt27o7vdr6i9eoe6r186krv8@group.calendar.google.com');
	    ...
	    if (isset($_POST['new-event-submit'])) {
	      ...
	      foreach ($inputArray as $input) {
	        ...
	        $newevent = $calendar->push($title, $description, $startDateTime, $endDateTime , '0hnt27o7vdr6i9eoe6r186krv8@group.calendar.google.com');
	    ...
	    if(isset($_POST['event-delete-submit'])){
	      $deleteevent = $calendar->delete('0hnt27o7vdr6i9eoe6r186krv8@group.calendar.google.com', $_POST['event-delete-id']);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Scouts - Calendar</title>
