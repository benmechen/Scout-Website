<?php
	...
	if ($logged = true) {
		...
		// Setup news
		$comments = new comments("scouts", $commentsDBH);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Scouts - Contact</title>
		...
		<section class="section-scouts" id='main'>
			...
			<div class="scouts-main-content main-content">
				...
				<div class="scouts-page-sidebar main-side">
					...
					<h2 class="anim_element anim_element--fadeIn">Email Scouts Leaders</h2>
...
<?
		...
		$seen = $notifications->seen($commentsDBH, "scouts");
