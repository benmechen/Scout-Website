<?php
	...
	if ($logged = true) {
		...
		// Setup news
		$comments = new comments("beavers", $commentsDBH);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Beavers - Contact</title>
		...
		<section class="section-beavers" id='main'>
			...
			<div class="beavers-main-content main-content">
				...
				<div class="beavers-page-sidebar main-side">
					...
					<h2 class="anim_element anim_element--fadeIn">Email Beavers Leaders</h2>
...
<?
		...
		$seen = $notifications->seen($commentsDBH, "beavers");
