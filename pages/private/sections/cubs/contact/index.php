<?php
	...
	if ($logged = true) {
		...
		// Setup news
		$comments = new comments("cubs", $commentsDBH);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Cubs - Contact</title>
		...
		<section class="section-cubs" id='main'>
			...
			<div class="cubs-main-content main-content">
				...
				<div class="cubs-page-sidebar main-side">
					...
					<h2 class="anim_element anim_element--fadeIn">Email Cubs Leaders</h2>
...
<?
		...
		$seen = $notifications->seen($commentsDBH, "cubs");
