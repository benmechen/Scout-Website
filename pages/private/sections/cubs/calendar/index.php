...
session_start();
	...
	if ($logged = true) {
		...
		$photosCheck = $notifications->checkGroup($photosDBH, "cubs");

		$newsCheck = $notifications->checkGroup($newsDBH, "cubs");

		$documentsCheck = $notifications->checkGroup($documentsDBH, "cubs");

		$commentsCheck = $notifications->checkGroup($commentsDBH, "cubs");


		// Set up Calendar
		$calendarId = 'qj7f5eeb6ugmqe32q5923ujt9o@group.calendar.google.com';
		$params = array(
		...
		$calendar = new Calendar('qj7f5eeb6ugmqe32q5923ujt9o@group.calendar.google.com');
	    ...
	    if (isset($_POST['new-event-submit'])) {
	      ...
	      foreach ($inputArray as $input) {
	        ...
	        $newevent = $calendar->push($title, $description, $startDateTime, $endDateTime , 'qj7f5eeb6ugmqe32q5923ujt9o@group.calendar.google.com');
	    ...
	    if(isset($_POST['event-delete-submit'])){
	      $deleteevent = $calendar->delete('qj7f5eeb6ugmqe32q5923ujt9o@group.calendar.google.com', $_POST['event-delete-id']);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Cubs - Calendar</title>
   ...
   $().ready(function() {  
	...
	<body onload="">
		<div class="cubs-header">
			<? include '../../../modules/header.php'; ?>
		</div>

		<section class="section-cubs" id='main'>
			
			<div class="cubs-hero">
				<h1><span class="title-highlight">Cubs</span></h1>
			</div>

			<div class="cubs-main-content main-content">
				<div class="cubs-page-nav">
					<ul>
						<a href="../" class="home">
							<li>
				...
				<div class="cubs-page-main anim_element anim_element--fadeInLeft">
					<iframe src="calendar.php" width="100%" class="calendar"></iframe>
					<!-- <iframe src="https://calendar.google.com/calendar/embed?showCalendars=0&amp;showTz=0&amp;height=600&amp;wkst=2&amp;bgcolor=%23ffffff&amp;src=lytchettscoutgroup%40gmail.com&amp;color=%23182C57&amp;ctz=Europe%2FLondon" style="border-width:0" width="100%" height="600" frameborder="0" scrolling="no"></iframe> -->			
					
				</div>

				<div class="cubs-page-sidebar main-side">
					...
					<div class="anim_element anim_element--fadeIn">
                       ...
                       $eventId = $event->getId();
							 		...
							 		?>
							        <li><?= $newday ?>/<?= $newmonth ?>/<?= $newyear ?> - <b><?= $event->summary; ?></b><? if ($uid == 2 || $uid == 100) {?> - <form action="" method="post" class="event-delete-form"><input type="hidden" value="<?=$eventId?>" name="event-delete-id"><input type="submit" value="Delete" name="event-delete-submit" class="event-delete-input"></form><? } ?></li>
							<?php
							  }
	...
	<script type="text/javascript">
		$(document).ready(function(){
		    $(".stripe").css({"padding-top":$(".section-cubs").height()/2+"px"});
		    $(".stripe").css({"padding-bottom":$(".section-cubs").height()/2+"px"});
		});		
	</script>
    <script type="text/javascript">  
     $().ready(function() {  
...
// 		 dataType: 'json',
// 		 formData: [{ name: 'custom_dir', value: '/Scout_Website_v2.0/pages/private/sections/cubs/photos/New Folder/' }],
...
<?
		...
		$seen = $notifications->seen($documentsDBH, "cubs");
