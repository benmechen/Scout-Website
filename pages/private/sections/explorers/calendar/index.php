...
session_start();
	...
	if ($logged = true) {
		...
		// Set up Calendar
		$calendarId = 'c2d6o34rpj3qsse0jenm5osapg@group.calendar.google.com';
		$params = array(
		...
		$calendar = new Calendar('c2d6o34rpj3qsse0jenm5osapg@group.calendar.google.com');
	    ...
	    if (isset($_POST['new-event-submit'])) {
	      ...
	      foreach ($inputArray as $input) {
	        ...
	        $newevent = $calendar->push($title, $description, $startDateTime, $endDateTime , 'c2d6o34rpj3qsse0jenm5osapg@group.calendar.google.com');
	    ...
	    if(isset($_POST['event-delete-submit'])){
	      $deleteevent = $calendar->delete('c2d6o34rpj3qsse0jenm5osapg@group.calendar.google.com', $_POST['event-delete-id']);
...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Explorers - Calendar</title>
...
<?
		...
		$seen = $notifications->seen($documentsDBH, "explorers");
