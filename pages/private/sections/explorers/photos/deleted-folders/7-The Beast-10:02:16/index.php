...
<html>
	<head>
		<title>1st Lytchett Matravers Scout Group | Explorers - <?=$dir?></title>
				...
				<div class="explorers-page-sidebar main-side">
					...
					<div class="anim_element anim_element--fadeIn">
						...
						<h3>Upload photos:</h3>
						    ...
						    <form id="fileupload" action="<?= $_PUBLIC_DIR ?>_inlcudes/upload/server/php/index.php?dir=<?= dirname($_SERVER["PHP_SELF"]) ?>" method="POST" enctype="multipart/form-data">   
