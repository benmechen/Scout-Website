...
<head>
    ...
    <title>1st Lytchett Scout Group Admin</title>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#webhunt"><i class="fa fa-fw fa-arrows-v"></i> Webhunt <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="webhunt" class="collapse">
                            <li>
                                <a href="../webhunt/">Public</a>
                            </li>
                            <li>
                                <a href="../webhunt/admin.php">Admin</a>
                            </li>
                        </ul>
                    </li>
                </ul>
